...
/** Get the native EventSource, or null if unavailable (Node.js). */
function getEventSource(): typeof EventSource | null {
  if (typeof globalThis.EventSource !== 'undefined') {
    return globalThis.EventSource;
  }
  // No native EventSource (Node.js) — caller should fall back to polling.
  return null;
}
