import type { YiviState } from './types';

/**
 * Transition map type - maps transition names to resulting states.
 */
export type TransitionMap = {
  [transition: string]: YiviState;
};

/**
 * State transitions definition type.
 */
export type StateTransitions = {
  startState: YiviState;
  endStates: YiviState[];
} & {
  [K in YiviState]: TransitionMap;
};
